...
<?php
	...
	foreach($model->gpcontinents as $relatedModel) {
...
<?php
	echo GxHtml::openTag('ul');
	foreach($model->gpregions as $relatedModel) {
		echo GxHtml::openTag('li');
...
<?php
	echo GxHtml::openTag('ul');
	foreach($model->gpsectors as $relatedModel) {
		echo GxHtml::openTag('li');
...
<?php
	echo GxHtml::openTag('ul');
	foreach($model->gpdocuments as $relatedModel) {
		echo GxHtml::openTag('li');
