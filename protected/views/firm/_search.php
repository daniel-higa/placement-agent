...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'firmtype_id'); ?>
		<?php echo $form->dropDownList($model, 'firmtype_id', GxHtml::listDataEx(Firmtype::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
